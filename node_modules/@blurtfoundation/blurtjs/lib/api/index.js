...
var Steem = function (_EventEmitter) {
    ...
    function Steem() {
        ...
        _this.alternative_api_endpoints = ['https://rpc.blurt.world', 'https://rpc.blurt.world'];
        ...
        console.log("Alternate endpoints: ", _this.options.alternative_api_endpoints);
        console.log("Failover Threshold (errors): ", _this.options.failover_threshold);
    ...
    _createClass(Steem, [{
        ...
        value: function setOptions(options) {
            ...
            if (options.hasOwnProperty('useTestNet')) {
                _config2.default.set('address_prefix', options.useTestNet ? 'TST' : 'BLT');
            }
