...
module.exports = [{
  ...
  "params": ["from", "to", "agent", "escrow_id", "blurt_amount", "fee", "ratification_deadline", "escrow_expiration", "json_meta"]
}, {
  "roles": ["active", "owner"],
  ...
  "params": ["from", "to", "agent", "who", "receiver", "escrow_id", "blurt_amount"]
}, {
  "roles": ["active", "owner"],
  ...
  "params": ["account", "reward_blurt", "reward_vests"]
}, {
  "roles": ["active", "owner"],
