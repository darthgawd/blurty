    ...
    appendByteBuffer: function appendByteBuffer(b, object) {
        ...
        if (object["nai"]) {
            ...
            switch (object["nai"]) {
                case "@@000000021":
                    precision = 3;
                    symbol = _config2.default.get("address_prefix") == "BLT" ? "BLURT" : "TESTS";
                    break;
                case "@@000000037":
                    precision = 6;
                    symbol = "VESTS";
...
Types.asset_symbol = {
    fromByteBuffer: function fromByteBuffer(b) {
        ...
        if (precision >= 16) {
            ...
            if (symbol == "BLURT" || symbol == "TESTS") nai_string = "@@000000021";else if (symbol == "VESTS") nai_string = "@@000000037";else throw new Error("Expecting non-smt core asset symbol, instead got '" + symbol + "'");
            b.skip(7);
        }
